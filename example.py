...
from pybricks.parameters import Color, Port, Direction, Button
...
def segunda_funcion_banderas():
    ...
    robot.rotate(90, 80)
    robot.run_cm(50, 2)
    medium_motor.safely_run_angle(-80, 300)
    robot.rotate(-45, 50)
    robot.rotate(-45, 50) 
...
def primera_antena():
    ...
    line_followers.follow_line_by_pid(50, 0.25, 0.01, 0.3, 11, LineSideLeft)
    robot.run_cm(80, 13)
